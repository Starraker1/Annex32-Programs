...
of the setup plus all of the usual BASIC commands. It also gets around the problems associated with screens and inbuilt sensors by 
having dedicated selectable Module implementations for most commercially available ESP Modules, touch, screens and displays, VGA and 
HMI devices. Also because the firmware is located in the ESP device, the programs run at a much higher speed - approaching a speed 
near to a compiler language especially on S3 and P4 devices which have ample memory.   Many users achieve fully working programs in
much less than a day and fully developed complex multi level / multi input LVGL programs in two to three days.
